...
def get_cart(x_session_id: Optional[str] = Header(default=None)):
...
def add_cart_item(payload: CartItemCreate, x_session_id: Optional[str] = Header(default=None)):
    session_id = _get_session_id(x_session_id)
...
def remove_cart_item(cart_item_id: str, x_session_id: Optional[str] = Header(default=None)):
    session_id = _get_session_id(x_session_id)
    items = CARTS.get(session_id, [])
